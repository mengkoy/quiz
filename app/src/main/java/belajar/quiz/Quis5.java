...
public class Quis5 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    Boolean jawaban1;
    Boolean jawaban2;
    Boolean jawaban3;
    Boolean jawaban4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quis5);
    ...
    public void next(View view) {
        if (rd1.isChecked() || rd2.isChecked() || rd3.isChecked() || rd4.isChecked() || rd5.isChecked()) {
            ...
            jawaban.putBoolean("jawaban5",jawaban5);
            i.putExtras(jawaban);
            startActivity(i);
            finish();
        } else {
